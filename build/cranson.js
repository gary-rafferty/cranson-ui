	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('card mb-2 plan'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(plan.address),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(plan.description),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
											...
											_0: A2(
												...
												},
												{
													...
													_0: _elm_lang$html$Html$text(
														A2(_elm_lang$core$Basics_ops['++'], 'Registered: ', plan.registrationDate)),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																_elm_lang$core$Basics$toString(plan.status)),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
...
var _gary_rafferty$cranson_ui$Cranson$viewPlansList = function (plans) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('plans'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Latest planning applications'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
...
var _gary_rafferty$cranson_ui$Cranson$Unknown = {ctor: 'Unknown'};
var _gary_rafferty$cranson_ui$Cranson$InProcess = {ctor: 'InProcess'};
var _gary_rafferty$cranson_ui$Cranson$Invalid = {ctor: 'Invalid'};
var _gary_rafferty$cranson_ui$Cranson$OnAppeal = {ctor: 'OnAppeal'};
var _gary_rafferty$cranson_ui$Cranson$Decided = {ctor: 'Decided'};
var _gary_rafferty$cranson_ui$Cranson$Pending = {ctor: 'Pending'};
var _gary_rafferty$cranson_ui$Cranson$planStatus = function (status) {
	var _p2 = status;
	switch (_p2) {
		case 'Pending':
			return _gary_rafferty$cranson_ui$Cranson$Pending;
		case 'Decided':
			return _gary_rafferty$cranson_ui$Cranson$Decided;
		case 'Invalid or Withdrawn':
			return _gary_rafferty$cranson_ui$Cranson$Invalid;
		case 'On Appeal':
			return _gary_rafferty$cranson_ui$Cranson$OnAppeal;
		case 'Current status not assigned in APAS':
			return _gary_rafferty$cranson_ui$Cranson$InProcess;
		default:
			return _gary_rafferty$cranson_ui$Cranson$Unknown;
	}
};
var _gary_rafferty$cranson_ui$Cranson$decodeStatus = function (status) {
	return _elm_lang$core$Json_Decode$succeed(
		_gary_rafferty$cranson_ui$Cranson$planStatus(status));
};
var _gary_rafferty$cranson_ui$Cranson$planDecoder = A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
								_elm_lang$core$Json_Decode$succeed(_gary_rafferty$cranson_ui$Cranson$Plan),
								A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int)),
							A2(_elm_lang$core$Json_Decode$field, 'address', _elm_lang$core$Json_Decode$string)),
						A2(_elm_lang$core$Json_Decode$field, 'description', _elm_lang$core$Json_Decode$string)),
					A2(_elm_lang$core$Json_Decode$field, 'reference', _elm_lang$core$Json_Decode$string)),
				A2(
					_elm_lang$core$Json_Decode$field,
					'status',
					A2(_elm_lang$core$Json_Decode$andThen, _gary_rafferty$cranson_ui$Cranson$decodeStatus, _elm_lang$core$Json_Decode$string))),
			A2(_elm_lang$core$Json_Decode$field, 'registration_date', _elm_lang$core$Json_Decode$string)),
		A2(
			_elm_lang$core$Json_Decode$field,
			'decision_date',
